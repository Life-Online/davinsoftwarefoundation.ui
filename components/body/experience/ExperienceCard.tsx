      ...
      <div className="container">
        <div className="row">
          <div className="col col-md-4 col-sm-12 col-xs-12">
            <Card
              style={{ width: "" }}
              className={`p-2 my-5 bg-white rounded-lg border border-gray-200 shadow-xl   ${styles.experienceCardContainer}`}
            >
              <Image
                src={data.traningImg}
                className={`${styles.experienceCardImg}`}
                alt=""
              />
              <Card.Body>
                <Card.Text
                  className={`my-2  text-[#EB4C29]  dark:text-white ${styles.experienceSmallText} `}
                >
                  {data.smallText}
                </Card.Text>
                <Card.Title className={`my-2 ${styles.experienceCardTitle} `}>
                  {data.heading}
                </Card.Title>
