...
const About: NextPage = () => {
  return ( <div>
     <div className={`preloader ${styles.theAboutHeader}`}>
        <Image className="preloader__image" width="60" src="/assets/images/loader.png"    height="500" alt="" />
    </div>
    <div className="page-wrapper">
                    ...
                    <div className="col-xl-6">
                        <div className="about-page__left">
                            <div className="about-page__img">
                                <Image src="/assets/images/resources/about-page-img-1.jpg" width="500" height="500" alt=""/>
                    ...
                    <div className="col-xl-6">
                        <div className="about-page__right">
                            <div className="section-title text-left">
                                ...
                                <h2 className="section-title__title">We believe that we can save more lifes</h2>
                            </div>
                            <p className="about-page__right-text">We are trusted by our clients and have a reputation for
                            ...
                            <h3 className="about-page__right-title">Halpes is the largest global crowdfunding community in
                                the world</h3>
        ...
        <section className="testimonial-one about-page-testimonial">
            <div className="testimonial-one-bg"
                style={{backgroundImage: "url(assets/images/backgrounds/testimonial-1-bg.jpg)"}}></div>
            <div className="container">
                <div className="row">
                    <div className="col-xl-4">
                        <div className="testimonial-one__left">
                            <div className="section-title text-left">
                                ...
                                <h2 className="section-title__title">What they’re talking about charity</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="testimonial-one__right">
                            <div className="testimonial-one__carousel owl-theme owl-carousel">
                                <div className="testimonial-one__single">
                                    ...
                                    <div className="testimonial-one__client-info">
                                        <div className="testimonial-one__client-img">
                                            <Image src="/assets/images/testimonial/testimonial-1-img-1.png" width="500" height="500" alt=""/>
                                ...
                                <div className="testimonial-one__single">
                                    ...
                                    <div className="testimonial-one__client-info">
                                        <div className="testimonial-one__client-img">
                                            <Image src="/assets/images/testimonial/testimonial-1-img-2.png" width="500" height="500" alt=""/>
                                            <div className="testimonial-one__quote">
        ...
        <section className="join-one join-one__about">
            <div className="join-one-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
                style={{backgroundImage: "url(assets/images/backgrounds/join-one-bg.jpg)"}}></div>
            <div className="container">
                <div className="row">
                    <div className="col-xl-12">
                        <div className="join-one__inner">
                            <h2 className="join-one__title">Join the community to give <br/> education for children</h2>
                            <a href="#" className="join-one__btn thm-btn"><i className="fas fa-arrow-circle-right"></i>Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <ul className="counters-one__box list-unstyled">
                    <li className="counter-one__single">
                        <h3 className="odometer" data-count="870">00</h3><span className="counter-one__letter">K</span>
                    ...
                    <li className="counter-one__single">
                        <h3 className="odometer" data-count="977">00</h3><span className="counter-one__letter">K</span>
                        <p className="counter-one__text">Happy People</p>
                    </li>
                    <li className="counter-one__single">
                        <h3 className="odometer" data-count="63">00</h3><span className="counter-one__letter">+</span>
                ...
                <div className="row">
                        ...
                        <div className="team-one__single">
                            <div className="team-one__img-box">
                                <div className="team-one__img">
                                    <Image src="/assets/images/team/team-one-img-1.jpg" width="500" height="500" alt=""/>
                                </div>
                    ...
                    <div className="col-xl-4 col-lg-4">
                        <div className="team-one__single">
                            <div className="team-one__img-box">
                                <div className="team-one__img">
                                    <Image src="/assets/images/team/team-one-img-2.jpg" width="500" height="500" alt=""/>
                                </div>
                                <div className="team-one__member-name">
                                    <h2>David</h2>
                                </div>
                    ...
                    <div className="col-xl-4 col-lg-4">
                        <div className="team-one__single">
                            <div className="team-one__img-box">
                                <div className="team-one__img">
                                    <Image src="/assets/images/team/team-one-img-3.jpg" width="500" height="500" alt=""/>
                                </div>
                                <div className="team-one__member-name">
                                    <h2>Sarah</h2>
                                </div>
                        ...
                        <div className="brand-one__carousel owl-theme owl-carousel">
                            <div className="brand-one__single">
                                <div className="brand-one__img">
                                    <Image src="/assets/images/resources/brand-1-1.png" width="500" height="500" alt=""/>
                                </div>
                            </div>
                            <div className="brand-one__single">
                                <div className="brand-one__img">
                                    <Image src="/assets/images/resources/brand-1-2.png" width="500" height="500" alt=""/>
                                </div>
                            </div>
                            <div className="brand-one__single">
                                <div className="brand-one__img">
                                    <Image src="/assets/images/resources/brand-1-3.png" width="500" height="500" alt=""/>
                                </div>
                            </div>
                            <div className="brand-one__single">
                                <div className="brand-one__img">
                                    <Image src="/assets/images/resources/brand-1-4.png" width="500" height="500" alt=""/>
                                </div>
                            </div>
                            <div className="brand-one__single">
                                <div className="brand-one__img">
                                    <Image src="/assets/images/resources/brand-1-5.png" width="500" height="500" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div className="mobile-nav__wrapper">
        ...
        <div className="mobile-nav__content">
            ...
            <div className="logo-box">
                <a href="index.html" aria-label="logo image"><Image src="/assets/images/resources/logo-1.png" height="500" width="155"
                        alt="" /></a>
            </div>
